      ...
      if (default_slot) {
        if (default_slot.p && (!current || dirty & 16777216)) {
          update_slot_base(
            ...
            ctx2,
            ctx2[24],
            !current ? get_all_dirty_from_scope(ctx2[24]) : get_slot_changes(default_slot_template, ctx2[24], dirty, null),
            null
          );
        }
      }
...
function create_fragment(ctx) {
  ...
  const switch_instance_spread_levels = [
    ...
    },
    {
      class: classMap({
        ...
        "mdc-fab": true,
        "mdc-fab--mini": ctx[6],
        "mdc-fab--exited": ctx[7],
        "mdc-fab--extended": ctx[8],
        "smui-fab--color-primary": ctx[5] === "primary",
        "mdc-fab--touch": ctx[9],
        ...ctx[14]
      })
    },
    {
      style: Object.entries(ctx[15]).map(func).concat([ctx[2]]).join(" ")
    },
    { href: ctx[10] },
    ctx[20]
  ];
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      const switch_instance_changes = dirty & 2086895 ? get_spread_update(switch_instance_spread_levels, [
        dirty & 4096 && { tag: ctx2[12] },
        dirty & 2031657 && {
          use: [
            [
              dist_default,
        ...
        dirty & 17378 && {
          class: classMap({
            ...
            "mdc-fab": true,
            "mdc-fab--mini": ctx2[6],
            "mdc-fab--exited": ctx2[7],
            "mdc-fab--extended": ctx2[8],
            "smui-fab--color-primary": ctx2[5] === "primary",
            "mdc-fab--touch": ctx2[9],
            ...ctx2[14]
          })
        },
        dirty & 32772 && {
          style: Object.entries(ctx2[15]).map(func).concat([ctx2[2]]).join(" ")
        },
        dirty & 1024 && { href: ctx2[10] },
