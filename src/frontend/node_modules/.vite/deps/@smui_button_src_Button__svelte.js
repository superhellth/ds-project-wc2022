...
// node_modules/@smui/button/src/Button.svelte
var file = "E:/Dokumente/Studium/Data Science/ds-project-wc2022/src/frontend/node_modules/@smui/button/src/Button.svelte";
      ...
      if (default_slot) {
        if (default_slot.p && (!current || dirty[0] & 1073741824)) {
          update_slot_base(
            ...
            ctx2,
            ctx2[30],
            !current ? get_all_dirty_from_scope(ctx2[30]) : get_slot_changes(default_slot_template, ctx2[30], dirty, null),
            null
          );
        }
      }
...
function create_fragment(ctx) {
  ...
  const switch_instance_spread_levels = [
    ...
    },
    {
      class: classMap({
        ...
        "mdc-card__action": ctx[18] === "card:action",
        "mdc-card__action--button": ctx[18] === "card:action",
        "mdc-dialog__button": ctx[18] === "dialog:action",
        "mdc-top-app-bar__navigation-icon": ctx[18] === "top-app-bar:navigation",
        "mdc-top-app-bar__action-item": ctx[18] === "top-app-bar:action",
        "mdc-snackbar__action": ctx[18] === "snackbar:actions",
        "mdc-banner__secondary-action": ctx[18] === "banner" && ctx[8],
        "mdc-banner__primary-action": ctx[18] === "banner" && !ctx[8],
        "mdc-tooltip__action": ctx[18] === "tooltip:rich-actions",
        ...ctx[12]
      })
    },
    {
      style: Object.entries(ctx[13]).map(func).concat([ctx[2]]).join(" ")
    },
    ctx[16],
    ctx[15],
    ctx[14],
  ...
  if (switch_value) {
    ...
    switch_instance.$on("click", ctx[22]);
  }
  const block = {
    c: function create() {
      if (switch_instance)
    ...
    p: function update(ctx2, dirty) {
      const switch_instance_changes = dirty[0] & 12580351 ? get_spread_update(switch_instance_spread_levels, [
        dirty[0] & 1024 && { tag: ctx2[10] },
        dirty[0] & 12189721 && {
          use: [
            [
              dist_default,
        ...
        dirty[0] & 266610 && {
          class: classMap({
            ...
            "mdc-card__action": ctx2[18] === "card:action",
            "mdc-card__action--button": ctx2[18] === "card:action",
            "mdc-dialog__button": ctx2[18] === "dialog:action",
            "mdc-top-app-bar__navigation-icon": ctx2[18] === "top-app-bar:navigation",
            "mdc-top-app-bar__action-item": ctx2[18] === "top-app-bar:action",
            "mdc-snackbar__action": ctx2[18] === "snackbar:actions",
            "mdc-banner__secondary-action": ctx2[18] === "banner" && ctx2[8],
            "mdc-banner__primary-action": ctx2[18] === "banner" && !ctx2[8],
            "mdc-tooltip__action": ctx2[18] === "tooltip:rich-actions",
            ...ctx2[12]
          })
        },
        dirty[0] & 8196 && {
          style: Object.entries(ctx2[13]).map(func).concat([ctx2[2]]).join(" ")
        },
      ...
      if (switch_value !== (switch_value = ctx2[9])) {
        ...
        if (switch_value) {
          ...
          switch_instance.$on("click", ctx2[22]);
          create_component(switch_instance.$$.fragment);
...
//# sourceMappingURL=@smui_button_src_Button__svelte.js.map
